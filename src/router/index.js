...
export const constantRouterMap = [
  ...
  },
  {
    path: '/pcbcalculator',
    component: Layout,
    redirect: '/PCBCalculator/index',
    children: [{
      path: 'index',
      component: _import('PCBCalculator/index'),
      name: 'PCB Calculator',
      meta: { title: 'PCB Calculator', icon: 'documentation', noCache: true }
    }]
  },
  {
    path: '/3dprintcalculator',
    component: Layout,
    redirect: '/3dPrintCalculator/index',
    children: [{
      path: 'index',
      component: _import('3dPrintCalculator/index'),
      name: '3D Print Calculator',
      meta: { title: '3D Print Calculator', icon: 'documentation', noCache: true }
    }]
  },
  {
    path: '/mechanicalproperties',
    component: Layout,
    redirect: '/mechanicalProperties/index',
    children: [{
      path: 'index',
      component: _import('mechanicalProperties/index'),
      name: 'Mechanical Properties',
      meta: { title: 'Mechanical Properties', icon: 'documentation', noCache: true }
    }]
  }
]

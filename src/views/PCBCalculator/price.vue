...
// import priceList from '../../store/static/price.json'
...
export default {
  ...
  computed: mapGetters({
    getAllPriceResponse: 'getAllPriceResponse'
  }),
  filters: {
    statusFilter(status) {
      const statusMap = {
  ...
  methods: {
    ...
    getList() {
      ...
      fetchList(this.listQuery).then(response => {
        this.list = this.getAllPriceResponse[0] // response.data.items // priceList.data
